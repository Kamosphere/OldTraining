...
public class Receipt {
    ...
    public double CalculateGrandTotal(List<Product> products, List<OrderItem> items) {
        ...
        return transformBigDecimalIntoDouble(grandTotal);
    }
    ...
    private double transformBigDecimalIntoDouble(BigDecimal trans){
        return trans.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue();
    }
